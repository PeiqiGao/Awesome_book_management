            ...
            axios({
                ...
                for(var i=0;i<length;i++)
                {
                    ...
                    changetd.onclick = function(){
                        ...
                        that.choosechange.availabe=document.getElementById('availabletd'+index).innerHTML
                        ...
                        data:qs.stringify({
                            ...
                            'bookname':that.choosechange.name
                }),
