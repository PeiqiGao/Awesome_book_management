<template>
    ...
    <div class="container">
                <div class="form">
                    ...
                    <form>
                        <div class="inputBox">
                            <input type="text" id="bookname" value="" placeholder="图书名称">
                        </div> 
                        <div class="inputBox">
                            <input type="text" id="author" value="" placeholder="作者姓名">
                        </div> 
                        <div class="inputBox">
                            <input type="text" id="price" value="" placeholder="价格">
                        </div> 
                        <div class="inputBox">
                            <input type="text" id="publishinghouse" value="" placeholder="出版社">
                        </div> 
                        <div class="inputBox">
                            <input type="text" id="bookshelf" value="" placeholder="书架">
                        </div> 
                    </form>
                    <div class="inputBox">
...
export default ({
    ...
    methods:
    {
        ...
        add(){
            ...
            this.authorname=document.getElementById('author').value;
            this.price=document.getElementById('price').value;
            this.publishinghouse=document.getElementById('publishinghouse').value;
            this.bookshelf=document.getElementById('bookshelf').value
            var that=this;
            axios({
                method:"post",
                ...
                data:qs.stringify({
                    ...
                    'price':that.price,
                    'publishinghouse':that.publishinghouse,
                    'type':that.bookshelf
                }),
